...
enum WindowSize {
  compact(0, 599, 16, 0,  0, 0),
  medium(600, 839, 24, 24,  -1.0, -1.0),
  expanded(840, 1199, 24, 24,  -2.0, -2.0),
  large(1200, 1599, 24, 24,  -3.0, -3.0),
  extraLarge(1600, double.infinity,24, 24,  -4.0, -4.0);

  const WindowSize(this.beginWidthRange, this.endWidthRange, this.margin, this.middleSpacing,  this.visualHorz, this.visualVert);
