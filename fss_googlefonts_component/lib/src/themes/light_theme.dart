...
import 'package:fss_googlefonts_component/src/themes/app_bar_theme.dart';
import 'package:fss_googlefonts_component/src/themes/primary_text_theme.dart';
import 'package:fss_googlefonts_component/src/themes/switch_theme_adaptation.dart';
import 'package:fss_googlefonts_component/src/themes/text_theme_light.dart';
...
ThemeData lightTheme(ColorScheme customColorScheme) {
  return ThemeData(
      ...
      appBarTheme: lightAppBarTheme(customColorScheme),
