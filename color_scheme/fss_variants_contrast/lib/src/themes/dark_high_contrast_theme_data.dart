...
import 'package:fss_variants_contrast/src/themes/dark_high_contrast_color_scheme.dart';
...
ThemeData darkHighContrastThemeData({
  ...
  return ThemeData(
    ...
    colorScheme: darkHighContrastColorScheme(brandOneSeedColor, brandTwoSeedColor, brandThreeSeedColor),
