...
import 'package:fss_variants_contrast/src/themes/light_color_scheme.dart';
...
ThemeData lightThemeData({
  ...
  return ThemeData(
    ...
    colorScheme:  lightColorScheme(brandOneSeedColor, brandTwoSeedColor, brandThreeSeedColor),
    ...
    appBarTheme: appBarTheme(
      ...
      toolbarTextStyle: Theme.of(context).textTheme.bodyMedium?.copyWith(color: Theme.of(context).colorScheme.onSurface),
    ),
