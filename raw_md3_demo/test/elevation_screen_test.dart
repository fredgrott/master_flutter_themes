...
void main() {
  testWidgets(
    ...
    final Finder tintIconOnBar = find.descendant(
    ...
    final Finder selectedTintIconOnBar = find.descendant(
        of: find.byType(NavigationBar),
  ...
  testWidgets(
    ...
    await tester.pumpWidget(const App());
    expect(find.text('Surface Tint Color Only'), findsNothing);
    final Finder tintIconOnRail = find.descendant(
    ...
    final Finder selectedTintIconOnRail = find.descendant(
