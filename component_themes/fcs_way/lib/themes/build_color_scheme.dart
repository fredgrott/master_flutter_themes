...
///    the iOS platform.
///
/// NOTE: Flex Color Scheme has two main ways to generate
///       color schemes. One is via FlexSchemeColor class
///       which is the legacy way to do it. Instead I use
///       the Flex Seed Scheme SeedColorScheme.fromSeeds 
///       way as that is meant to be used within the 
///       HCT color space.
///
