...
import 'package:sdk_cs_fonts_component/src/themes/custom_app_bar_theme.dart';
import 'package:sdk_cs_fonts_component/src/themes/primary_text_theme.dart';
import 'package:sdk_cs_fonts_component/src/themes/text_theme_light.dart';
...
ThemeData lightTheme(BuildContext context, ColorScheme customColorScheme) {
  return ThemeData(
    ...
    appBarTheme:  customLightAppBarTheme(context, customColorScheme),
  );
}
